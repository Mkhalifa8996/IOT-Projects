...
#define DEVICE_ID "area1"
//Device                 Org    Type    ID
#define MQTT_DEVICEID "d:9zlw2x:ESP8266:area1"
#define MQTT_USER "use-token-auth"
#define MQTT_TOKEN "area1_esp"
#define MQTT_TOPIC_DISPLAY "iot-2/cmd/display/fmt/json"

// Water Flow Sensor IBM_Watson data
char pubTopic1[] = "iot-2/evt/area1_WFS_FLitres/fmt/json";    // Water flow rate
char pubTopic2[] = "iot-2/evt/area1_WFS_TLitres/fmt/json";    // Amount of water consumed


// Soil Moisture Sensor IBM_Watson data
char pubTopic3[] = "iot-2/evt/area1_SMS_moisture/fmt/json";

// Solindoid Valve IBM_Watson data
char pubTopic4[] = "iot-2/evt/area1_SValve/fmt/json";
